      ...
      <div className="flex flex-wrap gap-3">
        {categories.map((cat) => (
          <Link
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-full border border-gray-200 hover:border-[#2e6ca6] hover:text-[#2e6ca6] text-sm font-medium transition-colors"
          >
            {cat.image?.url && (
              <img
                src={cat.image.url}
